//PARÂMETROS
/*Nem todos os parâmetros que definimos são utilizados quando uma função é
executada, devido a falta de argumentos. Por isso é importante nos prepararmos
para caso estes argumentos não sejam declarados.*/
...
/*Antes do ES6 a forma de definirmos um valor padrão para um parâmetro, era
...
/*Com o ES6 é possível definirmos o valor de um parâmetro direto na declaração
do mesmo, caso o argumento não seja passado no momento da execução.*/
...
Assim todos os argumentos que passarmos na ativação da função, ficarão dentro
do parâmetro.*/
...
//SPREAD ARGUMENT
/*O Spread pode ser muito útil para funções que recebem uma lista de argumentos
