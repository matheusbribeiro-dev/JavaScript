...
de uma promessa, ela pode ser resolvida, com a execução do primeiro argumento,
...
//RESOLVE()
/*Podemos passar um argumento na função resolve(), este será enviado
junto com a resolução da Promise.*/
...
//REJECT()
/*Quando a condição de resolução da promise não é atingida, ativamos a função
reject para rejeitar a mesma. Podemos indicar no console um erro, informando
...
//ASSÍNCRONO
/*As promises não fazem sentido quando o código executado dentro da mesma é
apenas código síncrono. O poder está na execução de código assíncrono que
...
fazer um encadeamento de promessas. O valor do primeiro argumento de cada then,
...
//FINALLY()
/*finally() executará a função anônima assim que a promessa acabar. A diferença
do finally é que ele será executado independente do resultado, se for resolvida
ou rejeitada.*/
...
resolvidas ou pelo menos uma rejeitada. A reposta é uma array com as
