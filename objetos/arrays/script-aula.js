...
/*Os próximos métodos que vamos falar sobre, são métodos modificadores
(mutator methods). Além de retornarem um valor, eles modificam a array original.
...
//[].SHIFT() E [].POP()
/*[].shift() remove o primeiro elemento da array e retorna o mesmo. [].pop()
...
do index. Remove a quantidade de itens que for passada no segundo parâmetro
(retorna esses itens).*/
...
Se você passar um valor como parâmetro, este será utilizado durante a junção de cada
item da array.*/
...
//[].SLICE()
/*[].slice(inicio, final) retorna os itens da array começando pelo início e indo
até o valor de final.*/
